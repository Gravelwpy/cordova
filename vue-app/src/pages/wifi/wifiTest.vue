<template>
  <div class="page">
    ...
    <div class="circle"  @click="localTest">
      <van-circle
        v-model="currentRate"
        :rate="rate"
        size="170px"
    ...
    <!--<div class="card">-->
      <!--<div class="card_left card_all">-->
        ...
        <!--&lt;!&ndash;<div style="font-size: 15px;margin-top: 5px;color: rgba(220,220,220,0.86);">每组默认20条数据</div>&ndash;&gt;-->
      <!--</div>-->
      ...
      getwifilist: function (num) {
        ...
        async function SSIDlist(info){
          ...
          if( wifi_data.wifi_test_list.length == 0 ) {
            ...
            // 获取wifi信息
            // console.log(JSON.stringify(wifi_data));
            // _this.$req.post('wifi/save_wifi_detail', {
            //   wifi_info_list : JSON.stringify(wifi_data),
            // })
            //   .then(res => {
            //     console.log(res);
