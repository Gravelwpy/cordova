<template>
  <div class="mystyle">
    ...
    <div class="login">
      ...
      <div class="demo-input-size margin_top_10" style="position: relative"><!--为什么不加relative无法显示-->
        <template>
      ...
      <div class="demo-input-size">
        <input type="text" style="background: none;border-bottom: 1px solid #c0c4cc;width: 100%;font-size: 14px;color: white;line-height: 40px;" placeholder="请输入电话"></input>
      </div>

      <div v-if="tele_form" class="attition">电话格式不正确</div>

      <div class="margin_top_10" style="position: relative">
        <el-button style="width: 100%;border: 0px;border-radius: 5px;background-color: rgba(100%,100%,100%,0.5);color: white" type="plain" @click="register_fun()" round>注册</el-button>
      </div>
...
<style scoped>
  ...
  .el-select /deep/ input::-webkit-input-placeholder{
    color: white;
    font-size: 15px;
    font-weight: bolder;
  }
